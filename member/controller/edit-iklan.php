...
$data = mysqli_query($conn, "SELECT * FROM produk a INNER JOIN user b on a.id_user=b.id_user WHERE id_produk = '".$_GET["id"]."'");
$data2 = mysqli_fetch_assoc($data);
$foto_produk=$data2["foto_produk"];
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
              <div class="row">
                <div class="col-sm-7 mx-auto ">
                  <hr class="divider">
                 <h2 class="text-center"><strong>Edit Jualan</strong></h2>
                 <hr class="divider">
                 <form class="mt-4" method="POST" action="" enctype="multipart/form-data">
                    <div class="form-group row">
                        <label for="judul_barang" class="col-md-3 ml-auto p-1">Judul Produk</label>
                        <div class="col-md-6 mr-auto">
                            <input type="text" name="judul_produk" class="form-control" placeholder="Judul Barang" required="" value="<?=$data2["judul_produk"]?>">
                        </div>
                    </div>
                    
                    <div class="form-group row">
                      <label for="kategori" class="col-md-3 ml-auto p-1">Kategori Produk</label>
                        <div class="col-md-6 mr-auto">
                            <select name="kategori_produk" class="form-control" required="">
                                <option value="<?=$data2["kategori_produk"]; ?>">
                                  <?=$data2["kategori_produk"]; ?>
                                </option>
                    ...
                    <div class="form-group row">
                      <label for="stok_produk" class="col-md-3 ml-auto p-1">Stok Produk</label>
                        <div class="col-md-6 mr-auto">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mr-auto">
                          <input type="text" name="harga_produk" placeholder="(contoh : 3000)" class="form-control" required="" value="<?=$data2["harga_produk"]?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mr-auto" >
                             <select name="lokasi_produk" class="form-control" required="">
                                  <option value="<?=$data2["lokasi_produk"];?>"><?=$data2["lokasi_produk"];?></option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mr-auto">
                          <input type="tel" name="no_telp_produk" class="form-control" placeholder="Masukkan nomor telepon yang aktif" required="" value="<?=$data2["no_telp_produk"]?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="deskripsi" class="col-md-3 ml-auto p-1">Deskripsi Produk</label>
                        <div class="col-md-6 mr-auto">
                          <textarea class="form-control" name="deskripsi_produk" placeholder="Maks. 200 kata" required="" style="min-height: 120px;"><?=$data2["deskripsi_produk"]; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mr-auto">
                            <label for="foto_produk" ">
                              <img src="../uploads/<?=$foto_produk ?>" width="80" height="90">
                              <input type="hidden" name="img" value="<?=$foto_produk?>">
                              <input class="mt-3"  name="foto_produk" type="file" accept="image/*">
                            </label>
                       </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-9 mx-auto p-1">
                            <button type="submit" name="kirim" class="btn btn-primary form-control">Edit Iklan</button>
                        </div>
                    </div>
                 </form>
                 <?php
                      if (isset($_POST['kirim'])) {
                          ...
                          if($nama_foto != ""){
                          	...
                          	$insert = mysqli_query( $conn, "UPDATE produk SET 
	                      	judul_produk		='".$_POST["judul_produk"]."',
	                      	kategori_produk		='".$_POST["kategori_produk"]."',
	                      	stok_produk			='".$_POST["stok_produk"]."',
	                      	harga_produk		='".$_POST["harga_produk"]."',
	                      	lokasi_produk		='".$_POST["lokasi_produk"]."',
	                      	no_telp_produk		='".$_POST["no_telp_produk"]."',
	                      	deskripsi_produk	='".$_POST["deskripsi_produk"]."',
	                      	foto_produk			='".$rename."'
	                      	WHERE id_produk		='".$_GET["id"]."'
	                      	");
		                      	if($insert){
			                       echo "<script>alert('Data telah di rubah'); window.location ='../iklan-member.php'; </script>";
			                      }else{
			                        echo 'Gagal merubah';
			                      }
                          }else{

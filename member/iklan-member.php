...
session_start();
include'../connect.php';
$result = mysqli_query($conn, "SELECT * FROM user a INNER JOIN produk b on a.id_user=b.id_user WHERE b.id_user = '".$_SESSION["id_user"]."' ORDER BY id_produk DESC");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-sm-10 mx-auto">
                    ...
                    <table class="table table-hover table-dark">
                        ...
                        <?php 
                         ...
                         ?>
                          <tr>
                            <td width="120px;"><img src="uploads/<?=$row['foto_produk'] ?>" width="80" height="90"></td>
                            <td width="250px;"><?=$row['judul_produk'] ?></td>
                            <td width="150px;"><?=$row['harga_produk'] ?></td>
                            <td width="200px;"><?=$row['tanggal_upload'] ?></td>
                            <td width="200px">
                                <a href="controller/edit-iklan.php?id=<?=$row['id_produk'] ?>"> 
                                  <button class="btn btn-primary">
                                    <img src="../img/icon/pensil.png" width="15px">
                                  Edit</button></a>
                                <a href="controller/hapus-iklan.php?id=<?=$row['id_produk'] ?>">
